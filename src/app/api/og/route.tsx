...
export const GET = (req: Request) => {
  ...
  const colors = isDark
    ? {
      ...
      authorBoxBg: 'rgba(255, 255, 255, 0.12)',
      authorBoxBorder: 'rgba(255, 255, 255, 0.3)',
      authorBoxText: '#ffffff',
      authorName: '#ffffff',
      authorSubtitle: '#a1a1aa',
      domainBg: 'rgba(0, 0, 0, 0.6)',
      domainBorder: 'rgba(255, 255, 255, 0.15)',
      domainPrompt: '#ffffff',
      domainText: '#ffffff'
    }
    : {
      // Architectural Blueprint Light Mode (Hacktron Style)
      outerBg: '#f3f2e8',
      ...
      footerBorder: '#dedad0',
      authorBoxBg: '#09090b',
      authorBoxBorder: '#09090b',
      authorBoxText: '#ffffff',
      authorName: '#09090b',
      authorSubtitle: '#71717a',
      domainBg: '#ffffff',
      domainBorder: '#dedad0',
      domainPrompt: '#09090b',
      domainText: '#09090b'
