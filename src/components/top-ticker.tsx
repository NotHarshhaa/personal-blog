  ...
  return (
    ...
    >
      <div className="flex w-full items-center justify-between px-4 sm:px-6 lg:px-8">
        <div className="flex min-w-0 items-center gap-2 overflow-hidden text-muted-foreground">
          <span className="inline-flex shrink-0 items-center gap-1.5 whitespace-nowrap font-bold uppercase tracking-wider text-foreground">
          ...
          <Link
            href="/posts"
            className="inline-flex shrink-0 items-center gap-0.5 whitespace-nowrap font-medium text-foreground underline underline-offset-3 hover:opacity-80"
          >
